<template>
    <v-container grid-list-md text-xs-left>
        <v-flex xs12 sm8 offset-sm2 class="white" style="padding: 0 2em 0 2em;">
            ...
            <p>Allgemeinbildung - Natur Mensch Technik e.V.</p>
            ...
            <p>connect.sid - nur für die dauer des Besuchs</p>
            ...
            <h3>Empfänger:</h3>
            <p>Empfänger der Daten sind nur die verantwortliche Stelle und ggf. technische Dienstleister, die für den Betrieb und die Wartung unserer Website als Auftragsverarbeiter tätig werden.</p>
            <h3>Speicherdauer:</h3>
            ...
            <p><em>Die Datenschutzerklärung wurde mit dem </em><em><a href="https://www.activemind.de/datenschutz/datenschutzhinweis-generator/" target="_blank" rel="noopener">Datenschutzerklärungs-Generator der activeMind AG erstellt</a> (Version 2018-06-15).</em></p>
